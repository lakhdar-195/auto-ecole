...
export default function Switcher({ sendDataToParent }) {
    ...
    return (
        <>
          <label className='themeSwitcherThree relative inline-flex cursor-pointer select-none items-center'>
            ...
            <div className='shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-gray-700 border border-gray-300'>
              <span className={`flex h-9 w-9 items-center justify-center rounded ${ !isChecked ? 'bg-primary text-gray-700' : 'text-red-700' }`} >
              ...
              <span  className={`flex h-9 w-9 items-center justify-center rounded ${ isChecked ? 'bg-primary text-gray-700' : 'text-green-600'  }`}  >
