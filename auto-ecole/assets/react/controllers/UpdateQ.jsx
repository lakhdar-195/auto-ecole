    ...
    <div className="container flex flex-col items-center justify-start px-6 py-1 mx-auto md:h-screen lg:py-0">
        <div className="lg:w-full p-6 bg-gray-50 sm:w-full md:w-full  rounded shadow border  dark:bg-gray-700 border-gray-700 sm:p-8">
            ...
            <div className="text-center mb-10 bg-gray-700 p-5 rounded  mx-0 lg:mx-10 items-center">
                <h2 className=" text-xl font-bold leading-relaxed tracking-tight text-white md:text-2xl dark:text-white ">Editer une question</h2>
            </div>
                    ...
                    <div className="mb-4">
                        <div className="w-full lg:mr-3 sm:mb-4 lg:mb-1">
                            <label htmlFor="question_img" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white  w-full">
                                <img ref={output} className="w-full border border-gray-700 mb-5 rounded" id="output" src={"../../../uploads/question/"+ $question.img}/>
                ...
                <div className="w-full lg:w-1/2 mx-0 lg:mx-10">
                    ...
                    <div className="block w-full mb-5">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Checkbox className="w-full" sendDataToParent={handleFirst} _data={first} />
                        </div>
                    </div>
                    <div className="block w-full mb-5">
                        <label htmlFor="Response_1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Réponse 1</label>
                        <div className="flex space-x-4">
                            ...
                            <Checkbox className="w-full" sendDataToParent={handleSecond} _data={second}  />
                        </div>
                    </div>
                    <div className="block w-full mb-5">
                        <label htmlFor="Response_1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Réponse 1</label>
                        <div className="flex space-x-4">
                            ...
                            <Checkbox className="w-full" sendDataToParent={handleThird}  _data={third} />
                        </div>
                    </div>
