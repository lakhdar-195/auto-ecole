...
<section className="bg-gray-white dark:bg-gray-700 pt-40 pb-60">
    <div className=" container flex flex-col items-center justify-start px-6 py-1 mx-auto md:h-screen lg:py-0 ">
        <div className="lg:w-full p-6 bg-gray-50 sm:w-full md:w-full  rounded shadow border  dark:bg-gray-700 border-gray-700 sm:p-8">

            <div className="text-center mb-10 bg-gray-700 p-5 rounded  mx-0 lg:mx-10 items-center">
                <h2 className=" text-xl font-bold leading-relaxed tracking-tight text-white md:text-2xl dark:text-white ">Ajouter une question</h2>
            </div>
            <div className="block lg:flex">
                <div className="w-full lg:w-1/2 mx-0 lg:mx-10 items-center">
                    <div className="mb-4">
                        <div className="w-full lg:mr-3 sm:mb-4 lg:mb-1">
                            <label htmlFor="question_img" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white  w-full">
                                <img ref={output} className="w-full border border-gray-700 mb-5 rounded" id="output" src="https://placehold.co/600x400/374151/FFF?text=Télécharger+image"/>
                                <div className="text-center  bg-gray-700 p-3 rounded  w-full items-center">
                                    <h2 className=" text-normal font-bold leading-relaxed tracking-tight text-white  dark:text-white ">Ajouter une image</h2>
                                </div>
                            </label>
                ...
                <div className="w-full lg:w-1/2 mx-0 lg:mx-10">
                    <div className="block w-full bg-gray-700 p-5 rounded mb-10 ">
                        <div className="w-full lg:mr-3 sm:mb-4 lg:mb-1 text-gray-50"> 
                            <label htmlFor="type" className="block mb-2 text-sm font-medium  dark:text-white">Type question</label>
                            
                            <select name="type" id="type" ref={type} className="bg-gray-700/5 border border-gray-300  text-sm rounded outline-none focus:ring-gray-100 focus:border-gray-100 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500">
                        ...
                        <div className="block w-full text-gray-50 ">
                            <div className="w-full lg:mr-3 sm:mb-4 lg:mb-1">
                                <label htmlFor="question" className="block mb-2 text-sm font-medium  dark:text-white">Question</label>
                                <input id="question" type="text" ref={question} className="bg-gray-700/5 border border-gray-300  text-sm rounded outline-none focus:ring-gray-100 focus:border-gray-100 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"/>
                                </div>
                        </div>
                    </div>
                    <div className="w-full ">
                        <div className="block w-full mb-5">
                            ...
                            <div className="flex space-x-4">
                                <input id="Response_1" type="text" ref={response_1} className="bg-gray-700 border border-gray-300 text-white text-sm rounded outline-none focus:ring-gray-900 focus:border-gray-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"/>
                                <Switcher className="w-full" sendDataToParent={handleFirst} />
                            </div>
                        </div>
                        <div className="block w-full mb-5">
                            <label htmlFor="Response_1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Réponse 2</label>
                            <div className="flex space-x-4">
                                <input id="Response_1" type="text" ref={response_2} className="bg-gray-700 border border-gray-300 text-white text-sm rounded outline-none focus:ring-gray-900 focus:border-gray-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"/>
                                <Switcher className="w-1/4" sendDataToParent={handleSecond} />
                            </div>
                        </div>
                        <div className="block w-full mb-5">
                            <label htmlFor="Response_1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Réponse 3</label>
                            <div className="flex space-x-4">
                                <input id="Response_1" type="text" ref={response_3} className="bg-gray-700 border border-gray-300 text-white text-sm rounded outline-none focus:ring-gray-900 focus:border-gray-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"/>
