    ...
    <div className=" flex flex-col items-center justify-start px-6 py-1 mx-auto md:h-screen lg:py-0">
        <div className="lg:w-2/5 p-6 bg-white sm:w-full md:w-full  rounded shadow border  dark:bg-gray-700 border-gray-700 sm:p-8">
            ...
            <div className="w-full text-center mb-10">
                ...
                <h2 className=" text-lg font-bold leading-relaxed tracking-tight text-gray-700 md:text-2xl dark:text-white mb-10">{result.type} </h2>
            </div>
            ...
            <div className="mb-4">
                ...
                <div className="flex w-full">
                    <div className="w-3/4 block lg:mr-3 sm:mb-4 lg:mb-1 first-letter:uppercase"> 
                    <h3 className=" text-lg font-bold leading-relaxed tracking-tight text-gray-700 md:text-2xl dark:text-white mb-10">{result.question}</h3>
                     </div>
